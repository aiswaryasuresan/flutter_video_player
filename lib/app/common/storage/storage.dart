...
abstract class Storage {
  ...
  static Future<void> saveValueIfNull(String key, dynamic value) => _storage.writeIfNull(key, value);

  static Future<void> saveValueForce(String key, dynamic value) => _storage.write(key, value);
